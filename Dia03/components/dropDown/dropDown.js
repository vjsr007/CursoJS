export class DropDown extends HTMLElement {
    ...
    getOptions = (data) => {
      ...
      return `<div title="[Select an option]" id="-1" class="option">[Select an option]</div>${options.join("")}`
    }
    ...
    populate = () => {
      ...
      return (`
          <div class="component">
            <div id="input" class="input">[Select an option]</div>
    ...
    getStyles = () => {
      ...
      fontAwesome.setAttribute("href", "./lib/fontawesome/css/font-awesome.min.css");
